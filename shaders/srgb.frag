// sRGB Mode: neutral soft, with reduced gamma.
// Gamma 1.10 brightens midtones moderately, saturation 0.96.
...
void main() {
    ...
    // Gamma: 1.10 brightens midtones moderately
